...
############# ################## create model  ######################  ############# 
    ...
    model = TSN(num_class, args.num_segments, args.modality,
                ...
                is_shift=args.shift, shift_div=args.shift_div, shift_place=args.shift_place, # T$M
...
############# ################## #### Data loading code  #### ######################  ############# 
    ...
    train_loader = torch.utils.data.DataLoader(
        TSNDataSet(args.root_path, args.train_list, num_segments=args.num_segments,
                   new_length=data_length, # 1 if rgb, 5 if rgbdiff or flow
                   modality=args.modality, # rgb, rgbdiff, or flow
                   image_tmpl=prefix,
